...
public class ModChestBoatEntity extends ChestBoat {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, ModBoatEntity.Type.SYCAMORE.ordinal());
        this.entityData.define(DATA_ID_TYPE, ModBoatEntity.Type.PLUM.ordinal());
        this.entityData.define(DATA_ID_TYPE, ModBoatEntity.Type.BLOODWOOD.ordinal());
