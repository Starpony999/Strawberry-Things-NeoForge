...
public class ModItems {
    ...
    public static final DeferredItem<Item> FRUIT_SALAD = ITEMS.register("fruit_salad", () -> new BowlItem(new Item.Properties().stacksTo(16).food(ModFoodProperties.FRUIT_SALAD)));
    public static final DeferredItem<Item> VEGGIE_STIR_FRY = ITEMS.register("veggie_stir_fry", () -> new BowlItem(new Item.Properties().stacksTo(16).food(ModFoodProperties.VEGGIE_STIR_FRY)));
    public static final DeferredItem<Item> SEAFOOD_STIR_FRY = ITEMS.register("seafood_stir_fry", () -> new BowlItem(new Item.Properties().stacksTo(16).food(ModFoodProperties.SEAFOOD_STIR_FRY)));
